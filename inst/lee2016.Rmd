...
On cherche $\hat\beta$ qui minimise
\[ || y - X\hat\beta ||_2^2, \> \text{avec } ||\hat\beta||_2^2 \le \text{constante}. \]
...
demo.lasso(x, y, input$lambda, xlim = c(-3,3), ylim = c(-3,3)), height = 470))
```
...
renderPlot( { 
  ...
  demo.lasso(x, y, input$lambda1, xlim = c(-3,3), ylim = c(-3,3))
  }, 
  height = 470)
```
